	...
	<div class="container">
		...
		<div id="navbar3" class="navbar-collapse collapse text-uppercase">
			<ul class="nav navbar-nav navbar-right">
				<li class="active"><a href="<%=request.getContextPath()%>">Chạy
						thuật toán</a></li>
				<li><a href="<%=request.getContextPath()%>/quan-ly-dataset">Quản
						lý dataset</a></li>
				<li><a href="<%=request.getContextPath()%>/danh-gia-thuat-toan">Đánh
						giá thuật toán</a></li>

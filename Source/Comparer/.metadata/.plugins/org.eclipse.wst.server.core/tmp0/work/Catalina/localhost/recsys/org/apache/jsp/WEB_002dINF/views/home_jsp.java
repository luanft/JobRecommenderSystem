 ...
 * Generated at: 2016-06-25 01:24:52 UTC
...
return;
    ...
    try {
      ...
      out.write("/ket-qua\">Task\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t1</a></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>20-6-2016</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>Collaborative Filtering</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>dataset 2</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>Đã xong</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>2</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td><a href=\"#\">Task 2</a></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>20-6-2016</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>Content Base</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>dataset 1</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>Lỗi</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t<tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>3</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td><a href=\"#\">Task 3</a></td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>20-6-2016</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>Hybrid</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>dataset 3</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<td>Đang chạy</td>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t</tr>\r\n");
      out.write("\t\t\t\t\t\t\t\t</tbody>\r\n");
      out.write("\t\t\t\t\t\t\t</table>\r\n");
      out.write("\t\t\t\t\t\t</div>\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label for=\"task\">Tên task</label><input type=\"text\"\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\trequired=\"required\" class=\"form-control\" id=\"task\" id=\"task\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label for=\"algorithm\">Chọn thuật toán</label><select\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tclass=\"form-control\" id=\"algorithm\" name=\"algorithm\">\r\n");
      ...
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t<div class=\"form-group\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t<label for=\"algorithm\">Chọn hoặc <a href=\"");
      out.print( request.getContextPath());
      out.write("/quan-ly-dataset\">nhập</a>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\tdataset\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</label><select class=\"form-control\" id=\"algorithm\" name=\"algorithm\">\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"cf\">dataset 1</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"cb\">dataset 2</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t\t<option value=\"hb\">dataset 3</option>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t\t</select>\r\n");
      out.write("\t\t\t\t\t\t\t\t\t\t</div>\r\n");
